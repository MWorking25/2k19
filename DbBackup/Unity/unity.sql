...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_pics
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: access_token
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel__aminities_reviews
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hotel__aminities_reviews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hotelid` int(11) DEFAULT NULL,
  `reviewedby` int(11) DEFAULT NULL,
  `reviewfor` int(11) DEFAULT NULL,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_aminities
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hotel_aminities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hotelid` int(11) DEFAULT NULL,
  `hotelroomid` int(11) DEFAULT NULL,
  `amenity` varchar(500) DEFAULT NULL,
  `amenity_icon` int(100) DEFAULT NULL,
  `createdby` int(11) DEFAULT NULL,
  `createddate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_booking
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_likes
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_master
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_review_items
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_room_photos
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hotel_room_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hotelroomid` int(11) DEFAULT NULL,
  `hotelid` int(11) DEFAULT NULL,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_rooms
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hotel_rooms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hotelid` int(11) DEFAULT NULL,
  `room_type` varchar(1500) DEFAULT NULL,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: hotel_subaminities
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hotel_subaminities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hotelid` int(11) DEFAULT NULL,
  `aminityid` int(11) DEFAULT NULL,
  `name` varchar(500) DEFAULT NULL,
  `createdby` int(11) DEFAULT NULL,
  `createddate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `fbdetails` varchar(10000) DEFAULT NULL,
  `googledetails` varchar(10000) DEFAULT NULL,
...
VALUES
  (
    ...
    NULL,
    0,
    'fcc8473853da748fe0a4d78df69459ae',
    '2019-05-17 09:47:50',
    NULL
  );
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: hotel_pics
# ------------------------------------------------------------


# ------------------------------------------------------------
# DATA DUMP FOR TABLE: access_token
# ------------------------------------------------------------
